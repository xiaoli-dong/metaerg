...
|cds.gene2ec.mapping.txt|Protein coding gene to ec number mapping file, which were used for MetaCyc pathway prediction|
|cds.gene2ko.mapping.txt|Protein coding gene to ec number mapping file, which were used for KEGG pathway prediction|
...
|cds.gene2ec.minpath.details|MinPath program output for predicting MetaCyc pathways|
|cds.gene2ko.minpath|MinPath program output for predicting KEGG pathways|
|cds.gene2ko.minpath.details|MinPath program output for predicting KEGG pathways|
