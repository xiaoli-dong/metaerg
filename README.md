...
|\*.minpath*| Pathway report files generated using MinPath program. On how to interpret the results, please refer to [how to read MinPath report](http://omics.informatics.indiana.edu/MinPath/readme.txt) |
